...
namespace Calisma19_Koleksiyonlar_Dictionary
{
    class Program
    {
        static void Main(string[] args)
        {
               ...
               kullanıcılar.Add(10,"Ayşe Yılmaz");  // key : 10 ,value : "Ayşe Yılmaz"
               ...
               Console.WriteLine(kullanıcılar.ContainsValue("Özcan Coşar"));
